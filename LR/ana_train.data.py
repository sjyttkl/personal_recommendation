...
def ana_train_data(input_trian_data, input_test_data, output_train_file, out_test_file, feature_num_file):
    ...
    for con_feature in con_feature_list:
        ...
        # 特征组合
    new_feature_len = combine_feature("age","capital_gain","age_gain", train_data_df, test_data_df, feature_num_dict)
    new_feature_len_two = combine_feature("capital_gain", "capital_loss", "loss_gain", train_data_df, test_data_df, feature_num_dict)
    ...
    # print("occc")
    # print(train_data_df["occupation"][:8])
    # print("age_co")
    # print(train_data_df["age_co"][:8])
    ...
    with open("../data/" + feature_num_file, "w", encoding="utf-8") as file_w:
        file_w.write("feature_num=" + str(dis_feature_num + con_feature_num+new_feature_len+new_feature_len_two))
...
if __name__ == "__main__":
    ana_train_data("../data/adult.data", "../data/adult.test", "../data/train_file", "../data/test_file",
                   "../data/feature_num")

    # 测试函数
    with open("../data/train_file", "r", encoding="utf-8") as file:
        count = 0
